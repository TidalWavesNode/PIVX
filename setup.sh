...
COIN_DAEMON='/usr/local/bin/pivxd'
COIN_CLI='/usr/local/bin/pivx-cli'
COIN_REPO='https://github.com/PIVX-Project/PIVX/releases/download/v3.2.1/pivx-3.2.1-x86_64-linux-gnu.tar.gz'
COIN_NAME='PIVX'
COIN_RPC=51473
COIN_PORT=51472
...
function compile_node() {
  ...
  compile_error
  cp bin/pivx{d,-cli} /usr/local/bin
  compile_error
